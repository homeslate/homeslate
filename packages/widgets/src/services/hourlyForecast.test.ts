...
describe("findHourlyStartIndex", () => {
  it("returns index of current hour", () => {
    const times = ["2026-07-15T12:00", "2026-07-15T13:00", "2026-07-15T14:00", "2026-07-15T15:00"];
  ...
  it("skips hours before now", () => {
    const times = ["2026-07-15T00:00", "2026-07-15T01:00", "2026-07-15T02:00"];
  ...
  it("uses the provided offset instead of the device local timezone", () => {
    ...
    const times = ["2026-07-15T15:00", "2026-07-15T16:00", "2026-07-15T17:00", "2026-07-15T18:00"];
  ...
  it("returns up to count when more hours exist", () => {
    ...
    expect(
      sliceHourlyFromNow({
        ...
        values,
        now,
        utcOffsetSeconds: deviceUtcOffsetSeconds(now),
        count: 12,
      }),
