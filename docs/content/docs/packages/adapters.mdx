...
description: Node stores for display documents and Google tokens.
---
...
- [API](/docs/api/adapters)
- [`@homeslate/schema`](/docs/packages/schema) — document types and validation
- [`@homeslate/google`](/docs/packages/google) — `TokenStore` / `GoogleBindingStore` interfaces
